...
describe('test fetch data of locationchange access card',() =>{
 before(() => {
  locationChangeGetStub.yields(null, [{category: 'Employee',accessType:'temp',empId :'50042924',empType:'temp',empName:'Shubhang',dateOfJoining:'12/07/20017',designation:'trainee',project:'stackroute',ou:'moon',status:'temp',dateOfExpiry:'19/12/2017',projectTransfer:'sita'
  ,existingLocation:'Greater Noida',newLocation:'Delhi',signature:'Shubhang',date:'21/11/2017' }]);
});
...
describe('test status of locationchange access card',() =>{
  before(() => {
    locationChangeGetStub.yields(null, [{category: 'Employee',accessType:'temp',empId :'50042924',
    empType:'temp',empName:'Shubhang',dateOfJoining:'12/07/2017',designation:'trainee',project:'stackroute',ou:'moon',status:'temp',dateOfExpiry:'19/12/2017',projectTransfer:'sita',existingLocation:'Greater Noida',newLocation:'Delhi',signature:'Shubhang',date:'21/11/2017' }]);
});
...
describe('test new record of locationchange access card', () => {
 let locationChangeInfo ={category: 'Employee',accessType:'temp',empId :'50042924',
 empType:'temp',empName:'Shubhang',dateOfJoining:'12/07/2017',designation:'trainee',project:'stackroute',ou:'moon',status:'temp',dateOfExpiry:'19/12/2017',projectTransfer:'sita',existingLocation:'Greater Noida',newLocation:'Delhi',signature:'Shubhang',date:'21/11/2017' };

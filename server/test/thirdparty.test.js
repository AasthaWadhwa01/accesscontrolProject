...
describe('test fetch data of thirdparty access card',() =>{
  before(() => {
    thirdPartyGetStub.yields(null, [{category: 'Client',location: 'Greater Noida', employeeName :'Shubhang',employeeId:'50042924',visitorName:'Rohit',visitingPurpose:'Project',duration:'7 days',
    dateOfVisiting:'12/12/2017',signature:'Shubhang',applicationDate:'21/11/2017' }]);
});

...
describe('test fetch data of employee access card',() =>{
  before(() => {
    employeeGetStub.yields(null, [{employeeId: 50042924,employeeName: 'Shubhang', empType :'Permanent',accessType:'temp',designation:'Trainee',dateOfJoining:'12/07/2017',dateOfExpiry:'18/12/2017',
     project:'slack-route',department:'Hr',existingProject:'Trainee',newProject:'Sita',requestDate:'10/07/2017',prev:'supervisor',current:'hr',zone:'Greater Noida',cardno:'123456',issuedBy:'Sheetal',issueDate:'12/07/2017' }]);
  });
...
describe('test fetch data of employee by employeeId of access card',() =>{
  before(() => {
    employeeIdGetStub.yields(null, [{employeeId: 50042924,employeeName: 'Shubhang', empType :'Permanent',accessType:'temp',designation:'Trainee',dateOfJoining:'12/07/2017',dateOfExpiry:'18/12/2017',
   project:'slack-route',department:'Hr',existingProject:'Trainee',newProject:'Sita',requestDate:'10/07/2017',prev:'supervisor',current:'hr',zone:'Greater Noida',cardno:'123456',issuedBy:'Sheetal',issueDate:'12/07/2017' }]);
});
...
describe('Test new record of employee access card', () => {
 let employeeInfo ={employeeId: 50042924,employeeName: 'Shubhang', empType :'Permanent',accessType:'temp',designation:'Trainee',dateOfJoining:'12/07/2017',dateOfExpiry:'18/12/2017',
 project:'slack-route',department:'Hr',existingProject:'Trainee',newProject:'Sita',requestDate:'10/07/2017',prev:'supervisor',current:'hr',zone:'Greater Noida',cardno:'123456',issuedBy:'Sheetal',issueDate:'12/07/2017'};
...
describe('test edit employee data using employeeId ',(done) =>{
  beforeEach(() => {
    employeeUpdateStub.yields(null, { employeeId : '50042924',

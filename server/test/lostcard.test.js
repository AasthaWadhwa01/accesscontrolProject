...
describe('test fetch data of lost access card',() =>{
  before(() => {
    lostCardGetStub.yields(null, [{employeeId :50042924,empoloyeeName:'Rohit',empType:'temp',accessType:'temp',
    designation:'trainee',dateOfJoining:'03/07/2017',dateOfExpiry:'03/12/2017',projct:'stackroute',department:'trainee',existingProject:'stackroute',newProject:'sita',requestDate:'09/12/2017',prev:'employee',current:'hr',zone:'internal',cardno:'12345',issueDate:'12/12/2017',date:'21/12/2017',comments:'card is damaged' }]);
});
...
/*describe('test new record of lost access card', () => {
 let lostCardInfo ={employeeId :50042924,empoloyeeName:'Rohit',empType:'temp',accessType:'temp',
    designation:'trainee',dateOfJoining:'03/07/2017',dateOfExpiry:'03/12/2017',projct:'stackroute',department:'trainee',existingProject:'stackroute',newProject:'sita',requestDate:'09/12/2017',prev:'employee',current:'hr',zone:'internal',cardno:'12345',issueDate:'12/12/2017',date:'21/12/2017',comments:'card is damaged' } ;
...
/*describe('test edit employee data using employeeId ',(done) =>{
  beforeEach(() => {
    lostCardUpdateStub.yields(null, { employeeId : '50042924',
      $set : {zone : 'Delhi',accessType:'temp',prev:'supervisor',current:'hr',issuedBy:'Sita',issueDate:'12/06/2017',cardno:'50040'}, ok: 1, nModified: 0, n: 0});
  });

  it('pasitive case of edit lostcard data using employeeId',(done) => {
    supertest(url)
    .put('/lostcard/update/50042924')
    .expect("Content-Type", /json/)
  ...
  it('negative case of edit lostcard data using employeeId',(done) => {
    supertest(url)
    .put('/lostcard/update/50042924')
    .expect("Content-Type", /json/)
    .send({$set : {zone : 'Delhi',accessType:'temp',prev:'supervisor',current:'hr',issuedBy:'Sita',issueDate:'12/06/2017',cardno:'50040'}})
...
describe('test fetch data of employee by employeeId of lostcard',() =>{
  before(() => {
    lostCardIdStub.yields(null, [{employeeId :50042924,empoloyeeName:'Rohit',empType:'temp',accessType:'temp',
    designation:'trainee',dateOfJoining:'03/07/2017',dateOfExpiry:'03/12/2017',projct:'stackroute',department:'trainee',existingProject:'stackroute',newProject:'sita',requestDate:'09/12/2017',prev:'employee',current:'hr',zone:'internal',cardno:'12345',issueDate:'12/12/2017',date:'21/12/2017',comments:'card is damaged' }]);
});

  it('validation for positive case of employee lostcard data fetch by employeeId',(done) => {
    supertest(url)
    .get('/lostcard/findemployeebyid/50042924')
    .expect(200)
    .expect('Content-Type', /json/)
    .end((err, res) => {
      if (err) return done(err);
 ...
 it('validation for negative case of employee lostcard data fetch by employeeId',(done) => {       
    supertest(url)
    .get('/lostcard/findemployeebyid/5004')
    .expect(200)
    .expect('Content-Type', /json/)
    .end((err, res) => {
      if (err) return done(err);

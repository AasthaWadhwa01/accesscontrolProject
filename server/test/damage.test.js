...
describe('test fetch data of damage access card',() =>{
  before(() => {
    damageCardGetStub.yields(null, [{empId :50042924,empType:'temp',name:'Rohit',doj:'03/07/2017',
      designation:'trainee',project:'stackroute',ou:'trainee',date:'21/12/2017',comments:'card is damaged',prev:'Supervisor',current:'Hr' }]);
  });
...
describe('Test new record of damage access card', () => {
 let damageCardInfo ={empId :50042924,empType:'temp',name:'Rohit',doj:'03/07/2017',
 designation:'trainee',project:'stackroute',ou:'trainee',date:'21/12/2017',comments:'card is damaged',prev:'Supervisor',current:'Hr' };

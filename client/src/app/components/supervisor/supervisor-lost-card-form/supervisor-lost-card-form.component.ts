...
@Component({
  selector: 'app-supervisor-lost-card-form',
  templateUrl: './supervisor-lost-card-form.component.html',
  styleUrls: ['./supervisor-lost-card-form.component.css']
})
export class SupervisorLostCardFormComponent implements OnInit {
	...
	acceptRequest(temp: any):void {
		...
		this.lostrequest.update(this.empp.employeeID, this.obj)
		.subscribe(res => {
			this.data=res;
		},
		error => {

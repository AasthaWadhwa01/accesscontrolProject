...
@Component({
  selector: 'app-cso-lost-card-form',
  templateUrl: './cso-lost-card-form.component.html',
  styleUrls: ['./cso-lost-card-form.component.css']
})
export class CsoLostCardFormComponent implements OnInit {
